...
const collabContent = [
    {
        ...
        text: "Candle’s blockchain integrates effortlessly with your existing workflows, delivering a unified and efficient experience.",
    },
        ...
        <Section crosses>
            <div className="container lg:flex">
                <div className="max-w-[25rem]">
                    <h2 className="h2 mb-4 md:mb-8">Candle Blockchain for Seamless Collaboration</h2>
                ...
                <div className="lg:ml-auto xl:w-[38rem] mt-4">
                    <p className="body-2 mb-8 text-n-4 md:mb-16 lg:mb-32 lg:w-[22rem] lg:mx-auto">
                        With powerful blockchain interoperability and top-notch security, Candle provides the ideal solution for teams seeking to work smarter and innovate faster.
                    </p>
                        ...
                        <div className="flex w-60 aspect-square m-auto border border-n-6 rounded-full">
                            <div className="w-[6rem] aspect-square m-auto p-[0.2rem] bg-conic-gradient rounded-full">
                                <div className="flex items-center justify-center w-full h-full bg-n-8 rounded-full">
                                    <img src={openai} width={48} height={48} alt="Candle" />
                                </div>
                            </div>
                        </div>
